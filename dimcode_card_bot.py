...
bot = TeleBot(token='6222544169:AAGz0kn7E4SAmiPELuE7olDyoYB50bhc6UU', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я помогу генерировать номер тестовой карты\nВыбери тип карты:', # текст сообщения
